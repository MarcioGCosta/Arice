...
yes | yay -S pfetch orphan-manager adobe-source-han-sans-otc-fonts ttf-liberation ttf-dejavu freecad-weekly-appimage

## Enabling daemons
sudo systemctl enable ufw.service && sudo systemctl enable ntpd.service && sudo systemctl enable libvirtd.socket
